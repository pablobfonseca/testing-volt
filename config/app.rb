...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-example.com'
  config.app_name = 'Volt-example'
  config.mailer.from = 'Volt-example <no-reply@volt-example.com>'
  ...
  #
  config.app_secret = '6oj0tgkyP-1F039UchTBbPEnz1bXfh9oKPSJlCfOWVMbPkVzuwcnWQPNdeLMIjyYnG0'
